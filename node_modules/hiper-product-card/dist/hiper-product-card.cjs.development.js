...
var useProduct = function useProduct(_ref) {
  ...
  var _useState = React.useState((initialValues === null || initialValues === void 0 ? void 0 : initialValues.count) || value),
      counter = _useState[0],
      setCounter = _useState[1];

  var isMounted = React.useRef(false);
  console.log(initialValues === null || initialValues === void 0 ? void 0 : initialValues.count);

  var increseBy = function increseBy(value) {
    var newValue = Math.max(counter + value, 0);

    if (initialValues !== null && initialValues !== void 0 && initialValues.maxCount) {
  ...
  var reset = function reset() {
    setCounter((initialValues === null || initialValues === void 0 ? void 0 : initialValues.count) || value);
  };
  ...
  return {
    counter: counter,
    increseBy: increseBy,
    maxCount: initialValues === null || initialValues === void 0 ? void 0 : initialValues.maxCount,
    isMaxCountReached: !!(initialValues !== null && initialValues !== void 0 && initialValues.count) && initialValues.maxCount === counter,
    reset: reset
  };
};
...
var ProductCard = function ProductCard(_ref) {
  ...
  var _useProduct = useProduct({
    ...
    initialValues: initialValues
      ...
      increseBy = _useProduct.increseBy,
      maxCount = _useProduct.maxCount,
      isMaxCountReached = _useProduct.isMaxCountReached,
      reset = _useProduct.reset; // y puedo manderle parametros
...
var ProductButtons = function ProductButtons(_ref) {
  ...
  var _useContext = React.useContext(ProductContext),
      ...
      increseBy = _useContext.increseBy,
      isMaxCountReached = _useContext.isMaxCountReached;
  ...
  return React__default.createElement("div", {
    ...
    className: "" + (!isMaxCountReached ? styles.buttonAdd : styles.disabled)
  }, "+"));
};
...
var ProductImage = function ProductImage(_ref) {
  ...
  var src = img$1 ? img$1 : (_product$img = product.img) !== null && _product$img !== void 0 ? _product$img : img;
...
var ProductTitle = function ProductTitle(_ref) {
  ...
  return React__default.createElement("span", {
    className: styles.productDescription + " " + className + " " + style
...
//# sourceMappingURL=hiper-product-card.cjs.development.js.map
